...
;   2     10.2015   CAN RX FIFO resized
;   3     12.2016   Updated with "univ3-routines-rev6.inc"
;==============================================================================
...
;==============================================================================
    ...
    #include "univ_3-102-0-1-rev3.inc"                       ;project variables
INCLUDEDFILES   code  
...
FIRMCHKSM   code    0x001000
    DB      0x65, 0x86, 0xF3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF            
;==============================================================================
;===  FIRMWARE ID  ============================================================
;==============================================================================
...
URXFIFORAM     EQU     0xB00                ;beginning of UART RX FIFO in RAM
