...
;==============================================================================
    ...
    #include "univ_3-102-0-1-rev0.inc"                       ;project variables
...
FIRMCHKSM   code    0x001000
    DB      0x65, 0xfb, 0x3f, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF            
;==============================================================================
;===  FIRMWARE ID  ============================================================
;==============================================================================
...
URXFIFORAM     EQU     0x700                ;begining of UART RX FIFO in RAM
...
USM_11xx
        movlw   0x30                        ;execute instruction request?
        xorwf   URXFIFO2,W
...
RTC_Main
    ...
    return                                  ;no
        ...
        rcall   RTC_SendPeriodicalToCan     ;send periodycally to CAN if enabled
        rcall   RTC_SendPeriodicalToUART    ;send periodycally to UART if enabled
    return
...
;------------------------------------------------------------------------------
; Overview:         Compares current time with prevoius one and saves new
;                   values if different
;------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------
; Overview:         Compares current time with prevoius one and sends if needed
;                   to CAN & UART
;------------------------------------------------------------------------------
